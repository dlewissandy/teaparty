...
class TestHeartbeatUpdate(unittest.TestCase):
    ...
    def test_activate_sets_status_running_and_subprocess_pid(self):
        ...
        from projects.POC.orchestrator.heartbeat import create_heartbeat, activate_heartbeat
    ...
    def test_touch_heartbeat_updates_mtime(self):
        ...
        from projects.POC.orchestrator.heartbeat import create_heartbeat, touch_heartbeat
...
class TestHeartbeatTerminalStatus(unittest.TestCase):
    ...
    def test_finalize_completed(self):
        ...
        from projects.POC.orchestrator.heartbeat import create_heartbeat, finalize_heartbeat
...
class TestHeartbeatStaleness(unittest.TestCase):
    ...
    def test_fresh_heartbeat_is_not_stale(self):
        ...
        from projects.POC.orchestrator.heartbeat import create_heartbeat, is_heartbeat_stale
    ...
    def test_read_heartbeat_returns_parsed_data(self):
        ...
        from projects.POC.orchestrator.heartbeat import create_heartbeat, read_heartbeat
...
class TestChildrenRegistry(unittest.TestCase):
    ...
    def test_read_children_returns_all_entries(self):
        ...
        from projects.POC.orchestrator.heartbeat import register_child, read_children
...
class TestOrphanDetectionHeartbeat(unittest.TestCase):
    ...
    def test_heartbeat_with_live_pid_not_orphaned(self):
        ...
        from projects.POC.orchestrator.worktree import find_orphaned_worktrees
...
class TestDispatchWorktreeHeartbeat(unittest.TestCase):
    ...
    def test_dispatch_creates_heartbeat_not_running(self):
        ...
        from projects.POC.orchestrator.worktree import create_dispatch_worktree

        with patch('projects.POC.orchestrator.worktree._run_git', new=AsyncMock()), \
             patch('projects.POC.orchestrator.worktree._run_git_output',
