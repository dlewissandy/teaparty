...
class TestLearningsWrapperPassesCategory(unittest.TestCase):
    ...
    def test_category_from_active_skill(self):
        ...
        from projects.POC.orchestrator.learnings import _archive_skill_candidate
        ...
        with patch('projects.POC.orchestrator.procedural_learning.archive_skill_candidate') as mock_archive:
