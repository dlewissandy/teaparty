...
class TestRetrieveMostRecentN(unittest.TestCase):
    ...
    def test_returns_n_most_recent(self):
        from projects.POC.orchestrator.proxy_memory import retrieve_most_recent_n
...
class TestReinforcementDistribution(unittest.TestCase):
    ...
    def test_basic_distribution(self):
        from projects.POC.orchestrator.proxy_metrics import reinforcement_distribution
