...
class TestFrictionEventDetection(unittest.TestCase):
    ...
    def test_detect_permission_denial(self):
        ...
        from orchestrator.procedural_learning import detect_friction_events
...
class TestFrictionEventSidecar(unittest.TestCase):
    ...
    def test_friction_sidecar_written_after_extraction(self):
        ...
        with patch('orchestrator.learnings._run_summarize'), \
             patch('orchestrator.learnings._promote_team'), \
             patch('orchestrator.learnings._promote_session'), \
             patch('orchestrator.learnings._promote_project'), \
             patch('orchestrator.learnings._promote_global'), \
             patch('orchestrator.learnings._promote_prospective'), \
             patch('orchestrator.learnings._promote_in_flight'), \
             patch('orchestrator.learnings._promote_corrective'), \
             patch('orchestrator.learnings._reinforce_retrieved'), \
             patch('orchestrator.learnings._archive_skill_candidate'), \
             patch('orchestrator.learnings._crystallize_skills'), \
             patch('orchestrator.learnings._compact_proxy_correction_entries'), \
             patch('orchestrator.learnings._compact_proxy_patterns'), \
             patch('orchestrator.learnings._reflect_on_skill_outcomes'):
...
class TestFrictionAwareSkillRefinement(unittest.TestCase):
    ...
    def test_refine_skill_with_friction_signals(self):
        ...
        from orchestrator.procedural_learning import refine_skill_with_friction
        ...
        with patch(
            'orchestrator.procedural_learning._apply_signals_to_skill',
...
class TestFrictionRefinementWiring(unittest.TestCase):
    ...
    def test_unified_refinement_called_when_skill_exists(self):
        ...
        with patch('orchestrator.learnings._run_summarize'), \
             ...
             patch('orchestrator.learnings._archive_skill_candidate'), \
             patch('orchestrator.learnings._crystallize_skills'), \
             patch('orchestrator.learnings._detect_and_write_friction'), \
             patch('orchestrator.learnings._compact_proxy_correction_entries'), \
             patch('orchestrator.learnings._compact_proxy_patterns'), \
             patch(
                 'orchestrator.learnings._refine_skill_unified',
...
class TestSkillQualityMetrics(unittest.TestCase):
    ...
    def test_update_friction_stats(self):
        ...
        from orchestrator.procedural_learning import update_skill_friction_stats
    ...
    def test_per_category_friction_breakdown(self):
        ...
        from orchestrator.procedural_learning import update_skill_stats
