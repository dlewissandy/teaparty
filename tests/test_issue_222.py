...
class TestBlendedText(unittest.TestCase):
    ...
    def test_concatenates_all_available_fields(self):
        from orchestrator.proxy_ablation import blended_text
...
class TestSingleCompositeScore(unittest.TestCase):
    ...
    def test_produces_valid_score(self):
        from orchestrator.proxy_ablation import single_composite_score
...
class TestEmbeddingAblation(unittest.TestCase):
    ...
    def test_per_context_breakdown_by_state_and_task_type(self):
        from orchestrator.proxy_ablation import run_embedding_ablation
    ...
    def test_threshold_below_95_percent(self):
        ...
        from orchestrator.proxy_ablation import apply_threshold
...
class TestPopulateBlendedEmbeddings(unittest.TestCase):
    ...
    def test_populates_missing_blended_embeddings(self):
        ...
        from orchestrator.proxy_ablation import populate_blended_embeddings
...
class TestRecordInteractionBlended(unittest.TestCase):
    ...
    def test_new_chunk_gets_blended_embedding(self):
        from unittest.mock import patch
        from orchestrator.proxy_memory import record_interaction, get_chunk
...
class TestRetrieveChunksScoringMode(unittest.TestCase):
    ...
    def test_single_scoring_uses_blended_embedding(self):
        from orchestrator.proxy_memory import retrieve_chunks
