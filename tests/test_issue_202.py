...
from orchestrator.human_presence import (
    HumanPresence,
    PresenceLevel,
)
from orchestrator.gate_queue import GateQueue, GateRequest
...
class TestDynamicNeverEscalate(unittest.TestCase):
    ...
    def test_task_assert_never_escalates_without_presence(self):
        ...
        from orchestrator.human_presence import should_never_escalate
        hp = _make_presence()
...
class TestObservationLevelMapping(unittest.TestCase):
    ...
    def test_state_to_level_mapping_used_in_gate(self):
        ...
        from orchestrator.human_presence import _STATE_TO_LEVEL
