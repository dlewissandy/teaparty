...
class _FakeSession:
    """Stand-in for launcher.Session — all the runner reads is ``.id``."""
...
def _make_runner(
    *,
    ...
    """Build a runner for testing _resolve_parent_conv_id."""
...
class TestResolveParentConvId(unittest.TestCase):
    ...
    def test_cfa_job_conv_id_is_used_verbatim(self) -> None:
        ...
        self.assertEqual(
            runner._resolve_parent_conv_id(),
    ...
    def test_chat_dispatched_conv_id_is_used_verbatim(self) -> None:
        ...
        self.assertEqual(
            runner._resolve_parent_conv_id(), 'dispatch:abcdef')
    ...
    def test_chat_om_conv_id_is_used_verbatim(self) -> None:
        ...
        self.assertEqual(
            runner._resolve_parent_conv_id(), 'om:some-qualifier')
