...
class TestLearningConflictClassificationConstants(unittest.TestCase):
    ...
    def test_cause_constants_exist(self):
        from orchestrator.learning_consolidation import (
...
class TestFindConflictingEntries(unittest.TestCase):
    ...
    def test_function_exists_and_is_callable(self):
        from orchestrator.learning_consolidation import find_conflicting_entries
...
class TestClassifyLearningConflict(unittest.TestCase):
    ...
    def test_function_exists_and_is_callable(self):
        from orchestrator.learning_consolidation import classify_learning_conflict
...
class TestConsolidateLearningEntries(unittest.TestCase):
    ...
    def test_function_exists_and_is_callable(self):
        from orchestrator.learning_consolidation import consolidate_learning_entries
...
class TestConsolidateLearningFile(unittest.TestCase):
    ...
    def test_function_exists_and_is_callable(self):
        from orchestrator.learning_consolidation import consolidate_learning_file
    ...
    def test_consolidates_task_directory(self):
        ...
        from orchestrator.learning_consolidation import consolidate_learning_file
        from scripts.memory_entry import serialize_entry
...
class TestConsolidateInstitutionalFile(unittest.TestCase):
    ...
    def test_function_exists_and_is_callable(self):
        from orchestrator.learning_consolidation import consolidate_institutional_file
    ...
    def test_consolidates_contradictory_entries(self):
        ...
        from orchestrator.learning_consolidation import consolidate_institutional_file
        from scripts.memory_entry import serialize_entry, serialize_memory_file
...
class TestTaskFilePersistence(unittest.TestCase):
    ...
    def test_importance_persisted_to_disk(self):
        ...
        from orchestrator.learning_consolidation import consolidate_learning_file
        from scripts.memory_entry import serialize_entry, parse_memory_file
...
class TestPipelineWiring(unittest.TestCase):
    ...
    def test_consolidate_task_and_institutional_learnings_exists(self):
        ...
        from orchestrator.learnings import _consolidate_task_and_institutional
    ...
    def test_consolidate_scope_helper_exists(self):
        ...
        from orchestrator.learnings import _consolidate_scope
