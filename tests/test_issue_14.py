...
from orchestrator.state_reader import StateReader, SessionState, DispatchState
...
class TestStateReaderDispatchResolution(unittest.TestCase):
    ...
    def test_dispatch_worktree_path_populated_from_manifest(self):
        ...
        reader = StateReader(self.layout['repo_root'], projects_dir=self.layout['projects_dir'])
        reader.reload()
