...
from orchestrator.proxy_memory import MemoryChunk
...
class TestFindConflictingPairs(unittest.TestCase):
    ...
    def test_same_state_opposing_outcomes_are_flagged(self):
        ...
        from orchestrator.proxy_memory import find_conflicting_pairs
...
class TestClassifyConflict(unittest.TestCase):
    ...
    def test_recency_gap_same_domain_is_preference_drift(self):
        ...
        from orchestrator.proxy_memory import classify_conflict
...
class TestFormatConflictContext(unittest.TestCase):
    ...
    def test_no_conflicts_returns_empty_string(self):
        ...
        from orchestrator.proxy_memory import format_conflict_context
...
class TestConsolidateProxyEntries(unittest.TestCase):
    ...
    def test_function_exists_and_is_callable(self):
        ...
        from orchestrator.proxy_memory import consolidate_proxy_entries
...
class TestConfidenceCalibrationWithConflicts(unittest.TestCase):
    ...
    def test_genuine_tension_caps_confidence(self):
        ...
        from orchestrator.proxy_memory import has_genuine_tension
...
class TestConsolidateProxyFile(unittest.TestCase):
    ...
    def test_function_exists_and_is_callable(self):
        from orchestrator.proxy_memory import consolidate_proxy_file
...
class TestAsymmetricConfidenceDecay(unittest.TestCase):
    ...
    def test_function_exists(self):
        from orchestrator.proxy_memory import apply_confidence_decay
...
class TestLLMClassifierFunctions(unittest.TestCase):
    ...
    def test_classify_conflict_llm_exists(self):
        ...
        from orchestrator.proxy_agent import _classify_conflict_llm
    ...
    def test_classify_conflict_llm_for_entries_exists(self):
        ...
        from orchestrator.proxy_agent import _classify_conflict_llm_for_entries
    ...
    def test_conflict_classify_prompt_template_exists(self):
        ...
        from orchestrator.proxy_agent import _CONFLICT_CLASSIFY_PROMPT
