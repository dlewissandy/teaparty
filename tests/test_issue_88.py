...
from scripts.cfa_state import make_initial_state, transition, save_state
...
class TestStageDetectionOnIntentApproval(unittest.TestCase):
    ...
    def test_detect_stage_called_after_intent_approval(self):
        ...
        with patch('orchestrator.engine.detect_stage_from_content',
    ...
    def test_stage_transition_triggers_retirement(self):
        ...
        with patch('orchestrator.engine.detect_stage_from_content',
                   return_value='implementation'), \
             patch('orchestrator.engine.retire_stage_entries',
    ...
    def test_no_intent_skips_detection(self):
        ...
        with patch('orchestrator.engine.detect_stage_from_content') as mock_detect:
            _run(orch._transition('approve', _make_actor_result()))
    ...
    def test_unknown_stage_no_retirement(self):
        ...
        with patch('orchestrator.engine.detect_stage_from_content',
             ...
             patch('orchestrator.engine.retire_stage_entries') as mock_retire:
            _run(orch._transition('approve', _make_actor_result()))
