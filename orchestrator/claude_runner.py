...
class ClaudeRunner:
    ...
    async def _stream_with_watchdog(self, stderr_lines: list[str]) -> int:
        ...
        async def heartbeat_writer():
            ...
            from orchestrator.heartbeat import activate_heartbeat, touch_heartbeat
        ...
        async def watchdog():
            ...
            while proc.returncode is None:
                ...
                if self.children_file and os.path.exists(self.children_file):
                    from orchestrator.heartbeat import read_children, is_heartbeat_stale
                ...
                if self.children_file and os.path.exists(self.children_file):
                    from orchestrator.heartbeat import read_children, read_heartbeat
        ...
        async def parent_watcher():
            ...
            from orchestrator.heartbeat import is_heartbeat_stale
