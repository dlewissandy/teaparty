...
Usage (from within a Claude agent session):
    python3 -m orchestrator.dispatch_cli --team art --task "..."
...
from orchestrator.merge import git_output, squash_merge
...
async def dispatch(
    ...
    if resume_worktree and resume_infra:
        ...
        from orchestrator.heartbeat import register_child, create_heartbeat
