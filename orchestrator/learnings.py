...
async def extract_learnings(
    *,
    ...
    """
    from orchestrator.events import EventType, Event
...
def _evaluate_promotions(*, infra_dir: str, project_dir: str) -> None:
    ...
    if embed_fn is not None:
        from orchestrator.proxy_memory import cosine_similarity
...
def _reinforce_retrieved(*, infra_dir: str, project_dir: str) -> None:
    ...
    from scripts.track_reinforcement import load_ids
    from scripts.memory_entry import parse_memory_file, serialize_memory_file
...
def _refine_skill_unified(*, infra_dir: str, project_dir: str) -> None:
    ...
    """
    import json
    from orchestrator.procedural_learning import (
        reflect_on_skill,
        update_skill_stats,
    )
...
def _consolidate_task_learnings(*, project_dir: str) -> None:
    ...
    token similarity.
    """
    from orchestrator.consolidate_learnings import (
...
def _compact_proxy_correction_entries(*, project_dir: str) -> None:
    ...
    from scripts.memory_entry import parse_memory_file, serialize_memory_file
    from scripts.compact_memory import compact_entries
