...
def create_server(agent_tools: set[str] | None = None) -> FastMCP:
    ...
    @server.tool(description=(
        ...
        'The responder launches inside a snapshot of your worktree, so '
        'every file you can read, they can read at the same relative '
        'path.  Reference deliverables by their path in your message; '
        'no attachments are needed.\n\n'
        'Args:\n'
        '    question: Your question, self-contained per the above.\n'
        '    context: Optional inline supporting text.'
    ))
