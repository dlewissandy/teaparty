...
import generate_review_bridge as mod
...
class TestFallbackBridge(unittest.TestCase):
    ...
    def test_known_state_with_file(self):
        ...
        try:
            ...
            self.assertIn("[INTENT_ASSERT]", result)
    ...
    def test_truncates_to_max_lines(self):
        ...
        try:
            ...
            # Should only have MAX_FALLBACK_LINES of content
            lines = result.split('\n')
            # First line is the header, then MAX_FALLBACK_LINES, then "..."
            content_lines = [l for l in lines[1:] if l != '...']
    ...
    def test_missing_file_returns_path_only(self):
        ...
        self.assertIn("[TASK_ESCALATE]", result)
