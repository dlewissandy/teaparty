...
Summary stats across all projects: jobs done, tasks done, active jobs, backtracks, withdrawals, escalations, proxy accuracy, cost (USD), skills learned. One row of numbers at the top.
