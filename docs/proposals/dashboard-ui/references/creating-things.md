...
The office manager handles creation through conversation. It knows the context (which project, which workgroup) and can ask clarifying questions, suggest configurations, and execute the creation.
