...
for relevance to a *specific* TeaParty mechanism — with particular attention to the in-progress
GitHub-bus + proxy-as-subscriber proposal (`docs/proposals/github-bus/proposal.md`) — and
classified as **SUPPORT** (evidence for our approach), **REFUTE** (evidence against it), or
**IMPROVE** (something we could adopt). Papers already in [INDEX.md](INDEX.md) were excluded.
