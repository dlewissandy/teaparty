...
Dispatch here when the task requires finding information that does not already exist in the project — from the web, academic databases, patent records, or video. The team retrieves and summarizes; it does not produce original content or perform deep analysis. Use it upstream of writing, planning, or editorial when those teams need source material they don't have.
...
Dispatch when the question can be answered by searching the open web — news, documentation, blog posts, grey literature, or anything not behind academic paywalls or in patent databases. Not for peer-reviewed literature (literature-researcher), patents (patent-researcher), or video content (video-researcher).
...
Dispatch when the task requires understanding or extracting information from visual content — screenshots, diagrams, photographs, or charts already in the project or accessible by URL. Not for producing images; that belongs to the art team.
