...
- Cold-start gating mechanism via ACT-R memory depth — built; threshold currently `0` (see `4f9d16ea`, 2026-04-17; re-tune slated for [#337](https://github.com/dlewissandy/teaparty/issues/337))
