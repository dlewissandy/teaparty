...
4. Call `CreateAgent(name, description, model, tools, body, skills, max_turns)` with the collected fields. The tool writes the file and validates required fields.
