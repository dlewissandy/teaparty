...
- Ground your analysis in the actual codebase. Read `agent_runtime.py`, `turn_policy.py`, `prompt_builder.py`, and the template YAML files to understand current social mechanics.
